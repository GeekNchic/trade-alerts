...
const SLACK_PREDICTIONS_URL = process.env.SLACK_ALERTS_URL;
const SLACK_REPORTS_URL = process.env.SLACK_TRENDS_URL;
const SLACK_TRADE_ALERT_URL = process.env.SLACK_TRENDS_URL;
